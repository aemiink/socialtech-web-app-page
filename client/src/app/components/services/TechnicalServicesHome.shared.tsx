...
export const seoProblems: TileData[] = [
...
export const seoRecipeTiles: TileData[] = [
...
export const seoPackages: PackageData[] = [
  {
...
export const webProcess: TileData[] = [
...
export const webFeatureGroups: FeatureGroup[] = [
  {
    title: "Teknik Destek",
    items: [
...
export const webPackages: PackageData[] = [
  {
...
export function LimeTile({ title, description, icon }: TileData) {
  return (
...
export function FeatureTile({ title, icon }: TileData) {
  return (
...
export function FaqCard({ question, answer }: FaqData) {
  return (
...
export function Hero({ variant }: { variant: TechnicalServicesVariant }) {
...
export function WebTechnicContent() {
  return (
    <>
...
export function PackagesSection({ variant }: { variant: TechnicalServicesVariant }) {
  const isSeo = variant === "seo";
...
export { ActionButton, CalendarDays, Check, Facebook, HeroBackdrop, Instagram, Link, Linkedin, Mail, Menu, MessageCircle, Package2, PackageFeatureBullet, PaymentLogos, X, Youtube, analyticsIcon, browserSearchIcon, calendarIcon, dashboardIcon, designIcon, fastIcon, flowIcon, gaugeIcon, getFooterLinkTarget, lightningIcon, logoImage, postAdsIcon, proPackageIcon, replyIcon, reportIcon, scalePackageIcon, searchIcon, seoAuditImage, seoRecipeImage, seoTeamImage, shopifyIcon, starterPackageIcon, technicalIcon, useState, usersIcon, webDesignIcon, wixIcon, wooIcon, wordpressIcon };
