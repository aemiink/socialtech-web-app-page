...
export function JourneyCard({ eyebrow, title, description, image, tone }: (typeof journeyCards)[number]) {
  const shell = {
...
export function StatCard({ title, body }: (typeof stats)[number]) {
...
export { ActionButton, ArrowRight, CalendarDays, Check, Facebook, HeroBackdrop, Instagram, Link, Linkedin, Mail, Menu, MessageCircle, Package2, PackageFeatureBullet, PaymentLogos, X, Youtube, accountImage, dashboardImage, flashIcon, getFooterLinkTarget, growthIcon, growthPackageIcon, launchPackageIcon, logoImage, meetingImage, nextStepImage, scalePackageIcon, targetIcon, useState };
