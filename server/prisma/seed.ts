...
const EMPLOYEE_CLIENT_ASSIGNMENTS: EmployeeClientAssignmentSeed[] = [
  ...
  {
    employeeEmail: "designer@socialtech.com",
    clientSlug: "acme-e-ticaret",
...
const PROJECT_SEEDS: ProjectSeed[] = [
  ...
  },
  {
    ...
    description: "Organic Social Media content calendar and client approval workflow.",
    serviceKey: PurchasedServiceKey.SOCIAL_MEDIA,
    status: ProjectStatus.IN_PROGRESS,
    priority: Priority.HIGH,
...
const PERMISSIONS: PermissionSeed[] = [
  ...
  { slug: "growthHub.actions.read.any", description: "Read all Growth Hub client actions." },
  { slug: "growthHub.actions.manage.any", description: "Create and manage all Growth Hub client actions." },
  { slug: "growthHub.actions.read.assigned", description: "Read assigned Growth Hub client actions." },
  { slug: "growthHub.actions.manage.assigned", description: "Create and manage assigned Growth Hub client actions." },
  { slug: "growthHub.actions.read.own", description: "Read own Growth Hub client actions." },
  { slug: "growthHub.notes.read.any", description: "Read all Growth Hub weekly notes." },
  { slug: "growthHub.notes.manage.any", description: "Create and manage all Growth Hub weekly notes." },
  { slug: "growthHub.notes.read.assigned", description: "Read assigned Growth Hub weekly notes." },
  { slug: "growthHub.notes.manage.assigned", description: "Create and manage assigned Growth Hub weekly notes." },
  { slug: "growthHub.notes.read.own", description: "Read own visible Growth Hub weekly notes." },
  { slug: "growthHub.reports.read.any", description: "Read all Growth Hub reports." },
  { slug: "growthHub.reports.manage.any", description: "Create, publish and manage all Growth Hub reports." },
  { slug: "growthHub.reports.read.assigned", description: "Read assigned Growth Hub reports." },
  { slug: "growthHub.reports.manage.assigned", description: "Create, publish and manage assigned Growth Hub reports." },
  { slug: "growthHub.reports.read.own", description: "Read own visible Growth Hub reports." },
  { slug: "growthHub.recommendations.read.any", description: "Read all Growth Hub recommendations." },
  { slug: "growthHub.recommendations.manage.any", description: "Generate and manage all Growth Hub recommendations." },
  { slug: "growthHub.recommendations.read.assigned", description: "Read assigned Growth Hub recommendations." },
  { slug: "growthHub.recommendations.manage.assigned", description: "Generate and manage assigned Growth Hub recommendations." },
  { slug: "growthHub.recommendations.read.own", description: "Read own visible Growth Hub recommendations." },
  ...
  { slug: "amazonAds.config.read.any", description: "Read all Amazon Ads configurations." },
  { slug: "amazonAds.config.manage.any", description: "Create and manage all Amazon Ads configurations." },
  { slug: "amazonAds.config.read.assigned", description: "Read Amazon Ads configurations in assigned scope." },
  { slug: "amazonAds.config.read.own", description: "Read own Amazon Ads configuration." },
  { slug: "amazonAds.reporting.read.any", description: "Read all Amazon Ads reports for any client." },
  { slug: "amazonAds.reporting.read.assigned", description: "Read Amazon Ads reports in assigned scope." },
  { slug: "amazonAds.reporting.read.own", description: "Read own Amazon Ads reports." },
  { slug: "amazonAds.notes.manage.assigned", description: "Create and manage Amazon Ads report notes in assigned scope." },
  { slug: "amazonAds.recommendations.manage.assigned", description: "Manage Amazon Ads performance recommendations in assigned scope." },
  { slug: "amazonAds.approvals.create.assigned", description: "Create Amazon Ads approval requests in assigned scope." },
  { slug: "amazonAds.productCollaboration.manage.assigned", description: "Manage Amazon Ads product collaboration tasks in assigned scope." },
  { slug: "amazonAds.sync.read.assigned", description: "Trigger/read Amazon Ads sync operations in assigned scope." },
  { slug: "amazonAds.sync.run.any", description: "Trigger Amazon Ads sync operations for any client." },
  { slug: "amazonAds.approvals.manage.any", description: "Manage all Amazon Ads approval requests." },
  { slug: "socialMedia.config.read.any", description: "Read all Social Media configurations." },
  { slug: "socialMedia.config.manage.any", description: "Create and manage all Social Media configurations." },
  { slug: "socialMedia.config.read.assigned", description: "Read Social Media configurations in assigned scope." },
  { slug: "socialMedia.config.read.own", description: "Read own Social Media configuration." },
  { slug: "socialMedia.summary.read.any", description: "Read all Social Media summaries." },
  { slug: "socialMedia.summary.read.assigned", description: "Read Social Media summaries in assigned scope." },
  { slug: "socialMedia.summary.read.own", description: "Read own Social Media summary." },
  { slug: "socialMedia.posts.read.any", description: "Read all Social Media content calendar posts." },
  { slug: "socialMedia.posts.manage.any", description: "Create and manage all Social Media content calendar posts." },
  { slug: "socialMedia.posts.read.assigned", description: "Read assigned Social Media content calendar posts." },
  { slug: "socialMedia.posts.manage.assigned", description: "Create and manage assigned Social Media content calendar posts." },
  { slug: "socialMedia.posts.assets.manage.assigned", description: "Manage assigned Social Media post assets." },
  { slug: "socialMedia.creatives.manage.assigned", description: "Manage assigned Social Media creative assets." },
  { slug: "socialMedia.approvals.create.assigned", description: "Create Social Media approval requests in assigned scope." },
  { slug: "socialMedia.reports.manage.assigned", description: "Manage assigned Social Media report notes." },
  { slug: "socialMedia.notes.manage.assigned", description: "Create and manage assigned Social Media workspace notes." },
  { slug: "design.approvals.create.assigned", description: "Create Web & Mobile Design approval requests in assigned scope." },
  { slug: "socialMedia.posts.read.own", description: "Read own visible Social Media content calendar posts." },
...
const ROLE_PERMISSIONS: Record<UserRole, readonly string[]> = {
  ...
  PROJECT_MANAGER: [
    ...
    "design.approvals.create.assigned",
  ...
  CLIENT_OWNER: [
    ...
    "growthHub.notes.read.own",
    "growthHub.reports.read.own",
    "growthHub.recommendations.read.own",
    "metaAds.config.read.own",
    "tiktokAds.config.read.own",
    "amazonAds.config.read.own",
    "socialMedia.config.read.own",
