...
const PERMISSIONS: PermissionSeed[] = [
  ...
  { slug: "googleAds.config.read.any", description: "Read all Google Ads configurations." },
  { slug: "googleAds.config.manage.any", description: "Create and manage all Google Ads configurations." },
  { slug: "googleAds.config.read.assigned", description: "Read Google Ads configurations in assigned scope." },
  { slug: "googleAds.config.read.own", description: "Read own Google Ads configuration." },
  { slug: "googleAds.reporting.read.assigned", description: "Read Google Ads reports in assigned scope." },
  { slug: "googleAds.notes.manage.assigned", description: "Create and manage Google Ads workspace notes in assigned scope." },
  { slug: "googleAds.approvals.create.assigned", description: "Create Google Ads approval requests in assigned scope." },
  { slug: "googleAds.sync.read.assigned", description: "Trigger/read Google Ads sync operations in assigned scope." },
  { slug: "googleAds.recommendations.manage.assigned", description: "Manage Google Ads recommendations in assigned scope." },
  { slug: "googleAds.reporting.read.any", description: "Read all Google Ads reports for any client." },
  { slug: "googleAds.sync.run.any", description: "Trigger Google Ads sync operations for any client." },
  { slug: "googleAds.approvals.manage.any", description: "Manage all Google Ads approval requests." },
