import { MetaAdsInsightLevel } from "@prisma/client";
import { Transform } from "class-transformer";
import { IsEnum, IsInt, IsOptional, Max, Min } from "class-validator";
import { MetaAdsDateRangeQueryDto } from "./meta-ads-date-range-query.dto";
...
export class MetaAdsInsightsQueryDto extends MetaAdsDateRangeQueryDto {
  @IsOptional()
  @Transform(({ value }) => normalizeOptionalInsightLevel(value))
  @IsEnum(MetaAdsInsightLevel)
