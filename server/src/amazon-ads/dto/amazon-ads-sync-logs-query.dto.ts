import { AmazonAdsSyncStatus } from "@prisma/client";
...
function normalizeOptionalSyncStatus(value: unknown): unknown {
  if (typeof value !== "string") {
    return value;
  }
...
export class AmazonAdsSyncLogsQueryDto {
  @IsOptional()
  ...
  @IsOptional()
  @Transform(({ value }) => normalizeOptionalSyncStatus(value))
  @IsEnum(AmazonAdsSyncStatus)
