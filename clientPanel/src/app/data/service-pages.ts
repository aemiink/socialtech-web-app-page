...
const profiles: Record<ServiceId, ServiceProfile> = {
  ...
  'amazon-ads': {
    ...
    tabs: {
      ...
      'asin-targeting': { title: 'ASIN Targeting', description: 'Rakip ASIN performansı, satış, ACOS ve fırsat notları.', focus: ['Competitor ASINs', 'Performance', 'Sales', 'ACOS', 'Opportunity notes'] },
      'retail-readiness': { title: 'Retail Readiness', description: 'Title, images, reviews, price, stock ve Buy Box kontrolü.', focus: ['Title', 'Images', 'Reviews', 'Price', 'Stock', 'Buy Box', 'Readiness checklist'] },
      'acos-tacos': { title: 'ACOS / TACOS', description: 'ACOS/TACOS trendi ve kârlılık notları.', focus: ['ACOS trend', 'TACOS trend', 'Profitability notes', 'Margin kontrolü'] },
    },
  },
  'web-app': {
