...
const serviceMenuItems: Record<string, MenuItem[]> = {
  'growth-hub': [
    ...
    { id: 'growth-summary', label: 'Büyüme Özeti', icon: TrendingUp },
  ...
  'meta-ads': [
    ...
    { id: 'pixel-events', label: 'Piksel ve Olaylar', icon: Activity },
  ...
  'tiktok-ads': [
    ...
    { id: 'hook-tests', label: 'Kanca Testleri', icon: PlayCircle },
    { id: 'audiences', label: 'Kitleler', icon: Users },
    { id: 'pixel-events', label: 'Piksel ve Olaylar', icon: Activity },
    { id: 'ugc-scripts', label: 'UGC Senaryoları', icon: FileText },
    { id: 'optimization-notes', label: 'Optimizasyon Notları', icon: Zap },
  ],
  'google-ads': [
    { id: 'service-dashboard', label: 'Genel Bakış', icon: LayoutDashboard },
    { id: 'search-campaigns', label: 'Arama Kampanyaları', icon: Search },
    ...
    { id: 'landing-page-notes', label: 'Açılış Sayfası Notları', icon: FileCode },
    { id: 'optimization-notes', label: 'Optimizasyon Notları', icon: Zap },
  ],
  'amazon-ads': [
    { id: 'service-dashboard', label: 'Genel Bakış', icon: LayoutDashboard },
    { id: 'campaigns', label: 'Kampanyalar', icon: Target },
    { id: 'sponsored-products', label: 'Sponsorlu Ürünler', icon: Package },
    { id: 'sponsored-brands', label: 'Sponsorlu Markalar', icon: Megaphone },
    { id: 'sponsored-display', label: 'Sponsorlu Görüntülü Reklamlar', icon: Eye },
    { id: 'products-asin', label: 'Ürünler / ASIN', icon: Package },
    { id: 'keywords', label: 'Anahtar Kelimeler', icon: Hash },
    { id: 'targeting', label: 'Hedefleme', icon: Target },
    { id: 'search-terms', label: 'Arama Terimleri', icon: Search },
    { id: 'amazon-reports', label: 'Raporlar', icon: BarChart3 },
    { id: 'agency-notes', label: 'Ajans Notları', icon: MessageSquare },
    { id: 'approvals', label: 'Onaylar', icon: CheckSquare },
  ],
  'web-app': [
    ...
    { id: 'ui-ux', label: 'Arayüz / Deneyim', icon: Palette },
    { id: 'frontend', label: 'Arayüz Geliştirme', icon: Code },
  ...
  'mobile-app': [
    ...
    { id: 'sprint-status', label: 'Sprint Durumu', icon: Target },
    { id: 'api-admin', label: 'API ve Yönetim Paneli', icon: Cpu },
    { id: 'push-notifications', label: 'Push Bildirimleri', icon: MessageSquare },
    { id: 'test-build', label: 'Test Paketi', icon: Zap },
    { id: 'store-readiness', label: 'Mağaza Hazırlığı', icon: CheckSquare },
    { id: 'revisions', label: 'Revizyonlar', icon: FileText },
  ],
  'landing-pages': [
    { id: 'service-dashboard', label: 'Genel Bakış', icon: LayoutDashboard },
    { id: 'brief-target', label: 'Brief & Hedef', icon: Target },
    { id: 'copywriting', label: 'Metin Yazımı', icon: FileText },
    { id: 'design', label: 'Tasarım', icon: Palette },
    { id: 'development', label: 'Geliştirme', icon: Code },
    { id: 'form-tracking', label: 'Form ve Takip', icon: Activity },
  ...
  'web-mobile-design': [
    ...
    { id: 'wireframe', label: 'Taslak Ekran', icon: Grid },
    { id: 'ui-screens', label: 'UI Ekranları', icon: Smartphone },
    { id: 'design-system', label: 'Tasarım Sistemi', icon: Palette },
