...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "google-ads", lazy: lazyComponent(() => import("./pages/GoogleAdsAdmin"), "GoogleAdsAdmin") },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "google-ads", lazy: lazyComponent(() => import("./employee/pages/GoogleAdsCalismaAlani"), "GoogleAdsCalismaAlani") },
